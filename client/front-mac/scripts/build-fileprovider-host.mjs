...
const appPath = path.join(buildRoot, 'ZCopyFileProviderHost.app')
const executablePath = path.join(appPath, 'Contents', 'MacOS', 'ZCopyFileProviderHost')
const bundledOutputPath = path.join(projectRoot, 'electron', 'fileprovider-host', 'ZCopyFileProviderHost.app')
